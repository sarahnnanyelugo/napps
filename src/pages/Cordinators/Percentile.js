...
const Percentile = () => {
    ...
    const handleChange = (index, field, value) => {
        ...
        let newValue = value;
        if ((parseInt(newValue) + parseInt(total)) > 100)
            newValue = 100 - total;
    ...
    const calculateTotal = (row) => {
        return ['federal', 'zonal', 'state', 'lga', 'ward', 'educare']
    ...
    return (
        <div>
                            ...
                            <tr key={item.id}>
                                ...
                                <td>
                                    <input
                                        ...
                                        onChange={(e) => handleChange(index, 'federal', e.target.value)}
                                ...
                                <td>
                                    <input
                                        ...
                                        value={item.zonal || ''}
                                        onKeyPress={handleKeyPress}
                                        onChange={(e) => handleChange(index, 'zonal', e.target.value)}
                                        maxLength="5" // Optional: limit the length
                                    />
                                </td>
                                ...
                                <td>
                                    <input
                                        ...
                                        value={item.ward || ''}
                                        onKeyPress={handleKeyPress}
                                        onChange={(e) => handleChange(index, 'ward', e.target.value)}
                                        maxLength="5" // Optional: limit the length
                                    />
                                </td>
                                ...
                                <td>
                                    <input
                                        ...
                                        value={item.educare || ''}
                                        onKeyPress={handleKeyPress}
                                        onChange={(e) => handleChange(index, 'educare', e.target.value)}
                                        maxLength="5" // Optional: limit the length
                                    />
                                </td>
            ...
            <div className="d-flex justify-content-end mt-3">
                <button onClick={handleSaveSplit} className="btn btn-success">Save</button>
            </div>

            <Card className={'container mt-3 col-md-4'}>
