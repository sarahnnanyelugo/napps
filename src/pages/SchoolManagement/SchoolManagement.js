...
export const SchoolManagement = () => {
  ...
  useEffect(() => {
    ...
    setNC([
      zones[0]?.schools_count,
      zones[0]?.active_schools_count,
      zones[0]?.inactive_schools_count,
    ]);
    setNE([
      zones[1]?.schools_count,
      zones[1]?.active_schools_count,
      zones[1]?.inactive_schools_count,
    ]);
    setNW([
      zones[2]?.schools_count,
      zones[2]?.active_schools_count,
      zones[2]?.inactive_schools_count,
    ]);
    setSE([
      zones[3]?.schools_count,
      zones[3]?.active_schools_count,
      zones[3]?.inactive_schools_count,
    ]);
    setSS([
      zones[4]?.schools_count,
      zones[4]?.active_schools_count,
      zones[4]?.inactive_schools_count,
    ]);
    setSW([
      zones[5]?.schools_count,
      zones[5]?.active_schools_count,
      zones[5]?.inactive_schools_count,
    ]);
  }, [data]);
  ...
  useEffect(() => {
    ...
    toast.error(
      error.response?.data?.message || "You may not have access to this page!"
    );
